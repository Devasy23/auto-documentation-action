...
def call_anthropic_api(prompt, max_tokens=3000):
    ...
    Returns:
        tuple: A tuple containing the API response content and an error message (or None if no error).

    Raises:
        None: This function does not raise exceptions, but returns errors as strings.
    """
...
def call_ai_api(prompt, max_tokens=3000):
    """Calls the specified AI API (Anthropic or Gemini).
